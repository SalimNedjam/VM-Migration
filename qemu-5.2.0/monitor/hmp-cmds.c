...
void hmp_info_migrate_parameters(Monitor *mon, const QDict *qdict)
{
    ...
    if (params) {
        ...
        monitor_printf(mon, "%s: '%s'\n",
            ...
            params->tls_hostname);
            assert(params->has_fingerprint_path);
        monitor_printf(mon, "%s: '%s'\n",
            MigrationParameter_str(MIGRATION_PARAMETER_FINGERPRINT_PATH),
            params->fingerprint_path);
...
void hmp_migrate_set_parameter(Monitor *mon, const QDict *qdict)
{
    ...
    case MIGRATION_PARAMETER_TLS_HOSTNAME:
        ...
        break;
    case MIGRATION_PARAMETER_FINGERPRINT_PATH:
        p->has_fingerprint_path = true;
        p->fingerprint_path = g_new0(StrOrNull, 1);
        p->fingerprint_path->type = QTYPE_QSTRING;
        visit_type_str(v, param, &p->fingerprint_path->u.s, &err);
        break;
