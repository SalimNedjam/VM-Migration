...
static void process_incoming_migration_co(void *opaque)
{
    ...
    mis->from_src_file->fingerprint_path = fingerprint_path;
    mis->from_src_file->uuid = qemu_uuid;
...
MigrationParameters *qmp_query_migrate_parameters(Error **errp)
{
    ...
    params->has_fingerprint_path = true;
    params->fingerprint_path = g_strdup(s->parameters.fingerprint_path); 
                                      ...
                                      MigrationParameters *dest)
{
    *dest = migrate_get_current()->parameters;
    ...
    if (params->has_fingerprint_path) {
        assert(params->fingerprint_path->type == QTYPE_QSTRING);
        dest->fingerprint_path = params->fingerprint_path->u.s;
    }
...
static void migrate_params_apply(MigrateSetParameters *params, Error **errp)
{
    ...
    if (params->has_fingerprint_path) {
        g_free(s->parameters.fingerprint_path);
        assert(params->fingerprint_path->type == QTYPE_QSTRING);
        s->parameters.fingerprint_path = g_strdup(params->fingerprint_path->u.s);
        fingerprint_path = s->parameters.fingerprint_path;
    }
...
void qmp_migrate_set_parameters(MigrateSetParameters *params, Error **errp)
{
    ...
    if (params->has_fingerprint_path
        && params->fingerprint_path->type == QTYPE_QNULL) {
        qobject_unref(params->fingerprint_path->u.n);
        params->fingerprint_path->type = QTYPE_QSTRING;
        params->fingerprint_path->u.s = strdup("");
    }
...
static void *migration_thread(void *opaque)
{
    ...
    s->to_dst_file->fingerprint_path = fingerprint_path;
    s->to_dst_file->uuid = qemu_uuid;
...
static void migration_instance_finalize(Object *obj)
{
    ...
    g_free(params->fingerprint_path);
